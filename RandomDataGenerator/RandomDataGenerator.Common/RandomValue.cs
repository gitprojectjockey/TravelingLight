...
namespace RandomDataGenerator.Common
{
    public static class RandomValue
    {
        ...
        public static string RandomEmployeeEmail(string name, string companyName)
        {
            return $"{name}@{companyName}.com";
        }

        public static string RandomCompanyEmail(string companyName)
        {
            return $"CustomerServices@{companyName}.com";
        }
